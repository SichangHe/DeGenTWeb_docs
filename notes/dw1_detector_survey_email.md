...
nine hundred fifty-eight qualifying detector accounts: two hundred sixty-three
previously expanded systems and six hundred ninety-five primary-paper
...
An independent table-row and grouped-method extraction now resolves four
thousand eight hundred sixty PDF-derived candidates with an explicit account or
content-specific reason. It first exposed the PAWN paper's separately reported RADAR fine-tuned
