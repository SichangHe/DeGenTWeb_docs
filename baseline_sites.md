...
- generated using Wix and B12 manually or w/ Browser-Use
    - no unsafety; publication does basically nothing beyond making a site
        crawlable; pretty much any problems can be reversed; created sites
        MUST be published so they can be crawled. Details:
        `codebase_index/provider_site_creation.md`
